...
By default this points to `world.gif` in this folder. If the file is missing the
game automatically reverts to the built-in drawn nature scene, so it always
works — just drop your `world.gif` in to use it.
